...
weight: 100
description: >
  在转到管理状态的主要机制是通过信道进行通信。 We saw this for example with worker pools. There are a few other options for managing state though. Here we’ll look at using the sync/atomic package for atomic counters accessed by multiple goroutines.
type: "docs"
---
